    ...
    <div className="p-4 md:p-6 lg:p-8 max-w-7xl mx-auto space-y-6 md:space-y-8 animate-fade-in">
      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-4 pb-4 border-b border-[#c4cfbc]">
        <div>
          ...
          <p className="text-sm text-[#8c947d] mt-2 flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-[#b7c3a1] inline-block" />
            Workload is <strong className="text-[#5e6544]">{capacityStatus.toLowerCase()}</strong> — let's make today count.
          </p>
        </div>
        <Button
          size="sm"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white border border-[#c4cfbc] rounded-2xl p-6 shadow-xs">
            <div className="flex items-center justify-between mb-5">
              ...
              <span className={`px-2.5 py-1 rounded-full text-[11px] font-bold uppercase tracking-wide border ${
                ...
                'bg-[#dfe8db] text-[#8c947d] border-[#c4cfbc]'
              }`}>
                {capacityStatus}
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 items-center">
              ...
              <div className="flex items-center justify-center">
                <div className="relative w-32 h-32">
                  <svg className="w-full h-full -rotate-90" viewBox="0 0 36 36">
                    <circle cx="18" cy="18" r="15.9" fill="none" stroke="#c4cfbc" strokeWidth="3.5" />
                    <circle
                      cx="18" cy="18" r="15.9"
                      fill="none"
                      stroke="#5e6544"
              ...
              <div className="sm:col-span-2 space-y-4">
                ...
                <div>
                  ...
                  <div className="w-full h-2.5 bg-[#c4cfbc] rounded-full overflow-hidden">
                    <div
            ...
            <div className="bg-[#5e6544] rounded-2xl p-5 shadow-sm relative overflow-hidden">
              ...
              <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white text-[#5e6544] text-xs font-bold hover:bg-[#eef1eb] transition-all shadow-xs shrink-0"
                >
            ...
            {isLoading ? (
              ...
              <div className="space-y-2.5">
                {topPriorities.map((task, index) => (
                  <div
                    key={task.id}
                    className="flex items-center gap-3.5 p-3.5 rounded-xl bg-[#dfe8db] border border-[#c4cfbc] hover:border-[#8c947d] transition-all group"
                  >
                    <span className="text-[11px] font-black text-[#b7c3a1] w-5 shrink-0">0{index + 1}</span>
                    <button
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        <span className={`inline-block px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wide border ${priorityBadge(task.priority)}`}>
                          {task.priority}
                        </span>
        ...
        <div className="space-y-5">
          ...
          {/* ── YOUR DAY TIMELINE ────────────────────────────────────────── */}
          <div className="bg-white border border-[#c4cfbc] rounded-2xl p-5 shadow-xs">
            <div className="flex items-center justify-between mb-4">
            ...
            <div className="relative space-y-4 pl-5 border-l-2 border-[#c4cfbc] ml-1">
              {[
                ...
                <div key={time} className="relative">
                  ...
                  <span className={`inline-block mt-0.5 px-1.5 py-0.5 rounded text-[9px] font-semibold uppercase tracking-wide ${
                    fixed ? 'bg-[#5e6544]/10 text-[#5e6544]' : 'bg-[#dfe8db] text-[#8c947d]'
                  }`}>
                    {type}
                  </span>
                </div>
          ...
          <div className="bg-white border border-[#c4cfbc] rounded-2xl p-5 shadow-xs">
            ...
            <div className="grid grid-cols-2 gap-2.5">
              {[
                ...
                <div key={label} className="p-3 rounded-xl bg-[#dfe8db] border border-[#c4cfbc]">
                  ...
                  <div className="w-full h-1 bg-[#c4cfbc] rounded-full overflow-hidden">
                    <div
